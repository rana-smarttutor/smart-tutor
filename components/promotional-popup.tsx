    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm transition-opacity duration-300">
      ...
      >
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="surface-soft rounded-3xl p-6 mb-8 bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100   w-full">
            <div className="flex justify-center mb-4">
              <span className="pill bg-blue-600 text-white border-blue-600 text-xs py-1 px-3">Limited Time Offer</span>
            </div>
            <h2 id="promo-title" className="text-3xl font-bold text-blue-900  mb-2">Get 30% OFF</h2>
            <p className="text-blue-700/80  mb-4 text-sm">
              On all Premium Mock Test Series and Course Enrollments this week!
            </p>
            <div className="text-sm font-mono bg-white/50  py-2 px-4 rounded-lg inline-block border border-blue-200 ">
              Use Code: <span className="font-bold text-blue-600 ">SMART30</span>
            </div>
          </div>
