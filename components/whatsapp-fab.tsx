...
export default function WhatsAppFAB({ currentCourseTitle }: WhatsAppFABProps) {
  ...
  const handleSendToWhatsApp = () => {
    const finalMsg = typedMsg.trim()
      ? typedMsg
      : `Hi SmartIQ Institute, I interested in receiving more information regarding the course: "${activeCourseLabel}". Please connect me with an expert counselor!`;
          ...
          >
            ...
            <div className="bg-emerald-600 text-white p-4 flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h4 className="font-display font-bold text-sm">SmartIQ Institute Help</h4>
