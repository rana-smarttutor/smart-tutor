...
// --- SECTION: Class 12 Regular Academic ---
{
  ...
  // --- SECTION: Skills - Global Skills ---
  {
    ...
    schedule: "Flexible Timing",
    summary: "Learn new languages and develop cross-cultural communication skills.",
    description: "Open doors to global opportunities by learning foreign languages and understanding diverse cultures. Perfect for students planning to study or work abroad.",
    duration: "3-6 Months",
    mode: "Online / Home Tutors",
    audienceLabel: "All Ages",
    courseNamesIncluded: ["Foreign Language (German)", "Foreign Language (French)", "Foreign Language (Japanese)", "Foreign Language (Spanish)", "Basic Sign Language"],
    branchesIncluded: [],
    subjectsCovered: [],
    points: [],
    audience: ["student", "parent", "admin"],
  ...
  // --- SECTION: Skills - Career Readiness ---
  {
    ...
    schedule: "Flexible Timing",
    summary: "Develop business acumen and entrepreneurial skills for future careers.",
    description: "Equip yourself with practical knowledge of business, finance, and entrepreneurship. Ideal for students who want to build a strong foundation for their professional journey.",
    duration: "3-6 Months",
    mode: "Online / Home Tutors",
    audienceLabel: "Teens & Adults",
    courseNamesIncluded: ["Entrepreneurship", "Financial Literacy", "Business Fundamentals", "Startup & Innovation"],
    branchesIncluded: [],
    subjectsCovered: [],
    points: [],
    audience: ["student", "parent", "admin"],
  ...
  // --- SECTION: Skills - Performing Arts & Hobby Skills ---
  {
    ...
    description: "Discover your artistic potential through visual arts, music, and dance. These courses provide a creative outlet while building discipline and self-expression.",
    duration: "3-6 Months",
    mode: "Online / Home Tutors",
    audienceLabel: "All Ages",
    courseNamesIncluded: ["Drawing & Sketching", "Painting", "Calligraphy", "Music (Vocal)", "Guitar", "Dance"],
    branchesIncluded: [],
    subjectsCovered: [],
    points: [],
    audience: ["student", "parent", "admin"],
  ...
  // --- SECTION: Skills - Technology & Future Skills ---
  {
    ...
    schedule: "Flexible Timing",
    summary: "Get future-ready with cutting-edge technology and innovation courses.",
    description: "Dive into the world of AI, robotics, coding, and digital literacy. These courses prepare students for the technology-driven future with hands-on learning and real-world applications.",
    duration: "3-6 Months",
    mode: "Online / Home Tutors",
    audienceLabel: "All Ages",
    courseNamesIncluded: ["Artificial Intelligence (AI Basics)", "Robotics", "Coding for Kids", "Internet & Digital Literacy", "Cyber Safety & Digital Citizenship", "STEM Innovation", "Drone Technology", "3D Printing", "Electronics & IoT Basics"],
    branchesIncluded: [],
    subjectsCovered: [],
    points: [],
    audience: ["student", "parent", "admin"],
  ...
  },
  {
    ...
    summary: "Comprehensive coaching for SSC CGL (Graduate Level) and CPO (Central Police Org) exams.",
    ...
    courseNamesIncluded: ["Quant Advanced", "Reasoning Mastery", "English Pro", "GK Express"],
  ...
  },
  {
    ...
    summary: "Focused preparation for RRB NTPC (Non-Technical) and Group D exams.",
    description: "Targeted coaching for Railway Recruitment Board exams covering General Awareness, Mathematics, General Intelligence, and relevant technical subjects for Group D posts.",
    duration: "6 Months",
    mode: "Home / Online Tutoring",
    ...
    points: ["PYQ-focused syllabus", "Speed-building drills", "Sectional analysis"],
    audience: ["student", "parent", "admin"],
  },
  {
    category: "Top Government Exams",
    ...
    summary: "Dedicated coaching for NDA (National Defence Academy) and CDS (Combined Defence Services) exams.",
    description: "Comprehensive prep for Mathematics, General Ability, and English for NDA & CDS. Includes SSB interview coaching, physical fitness guidance, and personality development.",
    duration: "6-12 Months",
    mode: "Home / Online Tutoring",
    audienceLabel: "Defence Aspirants",
    courseNamesIncluded: ["Maths for Defence", "GK & Current Affairs", "SSB Interview Prep"],
    branchesIncluded: ["Armed Forces", "Defence Services"],
    subjectsCovered: ["Mathematics", "English", "GK", "Physics", "Chemistry"],
    points: ["SSB coaching included", "Physical fitness tracking", "Mock SSB interviews"],
    audience: ["student", "parent", "admin"],
  },
];
