...
export const metadata: Metadata = {
  title: "Privacy Policy | SmartIQ Institute",
  description:
...
const sections = [
  {
    ...
    content: (
      <div className="space-y-2">
        <p>
          SmartIQ Institute collects personal information that you voluntarily provide
  ...
  },
  {
    ...
    content: (
      <div className="space-y-2">
        <p>
          SmartIQ Institute does <strong>not</strong> sell, rent, or share your
        ...
        <div className="rounded-lg border border-amber-200 bg-amber-50 p-4 text-amber-900">
          ...
          <p className="mt-1">
            SmartIQ Institute uses third-party service providers for cloud hosting
            ...
            networks over which SmartIQ Institute has no control.
          </p>
        </div>
      </div>
    ),
    ...
    content: (
      <div className="space-y-2">
        <p>
          ...
          by SmartIQ Institute for the sole purpose of identity verification and
          faculty onboarding.
        </p>
        <div className="rounded-lg border border-red-200 bg-red-50 p-4 text-red-900">
          <p className="font-bold">No Liability for Document Security:</p>
          <p className="mt-1">
            While we implement reasonable security measures, SmartIQ Institute{" "}
            <strong>does not and cannot guarantee</strong> the absolute security
            of uploaded identity documents. SmartIQ Institute, its operators,
      ...
      <div className="space-y-2">
        ...
        <div className="rounded-lg border border-red-200 bg-red-50 p-4 text-red-900">
          ...
          <p className="mt-1">
            ...
            is 100% secure. SmartIQ Institute{" "}
    ...
    content: (
      <div className="space-y-2">
        ...
        <div className="rounded-lg border border-amber-200 bg-amber-50 p-4 text-amber-900">
          ...
          <p className="mt-1">
            SmartIQ Institute reserves the right to charge for password reset
  ...
  },
  {
    ...
    content: (
      <p>
        If you access SmartIQ Institute via a mobile application, additional device
        ...
        explicit action. SmartIQ Institute is not responsible for any data leakage
    ...
    content: (
      <div>
        ...
        <div className="mt-2 space-y-1">
          ...
          <p>
            <strong>Address:</strong> SmartIQ Institute, Vashi, Navi Mumbai,
            Maharashtra, India
          </p>
        </div>
      </div>
