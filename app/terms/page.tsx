      ...
      <main className="mx-auto max-w-3xl px-4 py-16">
        ...
        <div className="mt-8 space-y-6 text-sm leading-7">
          <section>
            ...
            <p className="mt-2">
              By accessing or using the SmartIQ Institute platform, you agree to be bound by these Terms &amp; Conditions.
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              SmartIQ Institute is not liable for any loss or damage arising from your failure to safeguard your password.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              SmartIQ Institute is not liable for any consequences resulting from inaccurate or outdated information
              provided by users.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="mt-2 space-y-2">
              ...
              <ul className="mt-2 list-disc pl-6 space-y-1">
                ...
                <li>Consent to SmartIQ Institute storing, reviewing, and processing these documents for verification purposes</li>
              ...
              <div className="mt-3 rounded-lg border border-red-200 bg-red-50 p-4 text-red-900">
                ...
                <p className="mt-1">
                  SmartIQ Institute, its operators, and affiliates shall <strong>not be liable</strong> for any
          ...
          <section>
            ...
            <p className="mt-2">
              SmartIQ Institute, its operators, and affiliates shall not be held liable for any direct, indirect,
            ...
            <p className="mt-2">
              In no event shall SmartIQ Institute&apos; total aggregate liability exceed the amount paid by you
              to SmartIQ Institute during the twelve (12) months preceding the claim, or INR 1,000, whichever is
              greater. You agree to indemnify and hold harmless SmartIQ Institute from any claims arising from your
          ...
          <section>
            ...
            <p className="mt-2">
              The platform may contain links to third-party websites. SmartIQ Institute is not responsible for the
