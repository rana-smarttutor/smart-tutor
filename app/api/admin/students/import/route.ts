...
export async function POST(request: NextRequest) {
  try {
    ...
    const sendWelcomeEmail = formData.get("send_welcome_email") === "1";
    const skipDuplicates = formData.get("skip_duplicates") !== "0";
    const autoGeneratePassword = formData.get("auto_generate_password") !== "0";
