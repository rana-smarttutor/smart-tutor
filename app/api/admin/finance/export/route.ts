...
const [
  ...
  (async () => {
    ...
    workbook.creator = "Smart Tutors";
    workbook.lastModifiedBy =
      authorization.session?.name ||
      "Smart Tutors Admin";
    workbook.created = new Date();
    workbook.modified = new Date();
    workbook.company = "Smart Tutors";
    workbook.subject =
    ...
    formatWorksheetTitle(
      dashboardSheet,
      "Smart Tutors Finance Dashboard",
    ...
    workbook.eachSheet((worksheet) => {
      ...
      worksheet.headerFooter.oddFooter =
        `Smart Tutors Finance Report | Generated by ${authorization.session?.name ?? "Admin"} | Page &P of &N`;
    });
