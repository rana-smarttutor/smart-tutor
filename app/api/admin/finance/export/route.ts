...
const [
  ...
  (async () => {
    ...
    workbook.creator = "Smart IQ Institute";
    workbook.lastModifiedBy =
      authorization.session?.name ||
      "Smart IQ Institute Admin";
    workbook.created = new Date();
    workbook.modified = new Date();
    workbook.company = "Smart IQ Institute";
    workbook.subject =
    ...
    formatWorksheetTitle(
      dashboardSheet,
      "Smart IQ Institute Finance Dashboard",
    ...
    workbook.eachSheet((worksheet) => {
      ...
      worksheet.headerFooter.oddFooter =
        `Smart IQ Institute Finance Report | Generated by ${authorization.session?.name ?? "Admin"} | Page &P of &N`;
    });
